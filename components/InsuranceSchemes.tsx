...
const SCHEMES = [
  {
    ...
    description: 'NHIA accreditation supports GIFSHIP enrolment for informal-sector workers and community groups.',
    icon: (
  ...
  },
  {
    ...
    description: 'GMC works with the Enugu State UHC Agency to enrol residents and expand financial protection.',
    icon: (
      <svg className="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'CEmONC for Pregnancy Emergencies',
    description: 'The federally supported Comprehensive Emergency Obstetric and Newborn Care programme funded 91 free caesarean sections in five months, saving vulnerable families ₦40.9 million.',
    icon: (
      <svg className="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-lg text-slate-600 leading-relaxed font-light">
              GMC’s cross-subsidy model uses revenue from higher-income patients, public insurance and partner support to fund subsidised and free care. At least 30% of annual operational surplus is committed to vulnerable patients.
            </p>
