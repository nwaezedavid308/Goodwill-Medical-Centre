...
const InceptionReport: React.FC = () => (
  <main id="main-content" className="pt-16 px-6 max-w-7xl mx-auto min-h-screen">
    ...
    <Section eyebrow="Conclusion" title="A Call to Action">
      <div className="bg-purple-600 text-white rounded-[3rem] p-10 md:p-16"><p className="text-lg leading-relaxed text-purple-50">In two years, GMC served more than 12,500 patients, delivered 91 free life-saving caesarean sections, restored sight through 91 cataract surgeries, trained more than 30 Traditional Birth Attendants and built a bridge connecting communities long cut off from care. Continued partnership will expand service reach, upgrade infrastructure and develop the people who make healing possible.</p><p className="mt-6 font-bold">Goodwill Medical Centre · Umuchigbo, Enugu East LGA · 0802 409 4488 · 0703 258 5626 · Toll-free 0800 005 7777</p></div>
    </Section>
